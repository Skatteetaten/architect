...
func TestBuild(t *testing.T) {
	...
	t.Run("Overwrite should NOT be allowed for semanticVersion", func(t *testing.T) {
		...
		completeVersion := ""
		err := checkTagsForOverwrite(false, tags, tagWith, semanticVersion, completeVersion)
	...
	t.Run("Overwrite should be allowed for snapshot", func(t *testing.T) {
		...
		semanticVersion := "1.3.1"
		completeVersion := ""
		err := checkTagsForOverwrite(true, tags, tagWith, semanticVersion, completeVersion)
